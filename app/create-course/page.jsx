  ...
  return (
    <div>
      ...
      <div className='flex flex-col justify-center items-center mt-10'>
        <h2 className='text-4xl text-primary font-black'>Create Course</h2>
      ...
      <div className='flex justify-between mt-10'>
       ...
       {activeIndex<2&& <Button disabled={checkStatus()} className="border" onClick={() => setActiveIndex(activeIndex + 1)}>Next</Button>}
